...
.PARAMETER MaxConcurrent
    Number of concurrent migration jobs. Must be between 1 and 10. Defaults to 10.
...
if ($MaxConcurrent -gt 10) {
    Write-Host "[ERROR] Maximum concurrent migrations ($MaxConcurrent) exceeds the allowed limit of 10." -ForegroundColor Red
    exit 1
}
